...
class MainCommand(BaseSQLModel, table=True):
    ...
    def validate_params_format(self):
        ...
        if (self.params is None) != (self.format is None):
            raise ValueError ("params and format must both be none or have values for both")
        ...
        raise ValueError("params and format must both be None or have the same number of comma seperated values")
